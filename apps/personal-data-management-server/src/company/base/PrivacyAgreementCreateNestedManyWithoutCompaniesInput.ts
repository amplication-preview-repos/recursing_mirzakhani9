...
@InputType()
class PrivacyAgreementCreateNestedManyWithoutCompaniesInput {
...
export { PrivacyAgreementCreateNestedManyWithoutCompaniesInput as PrivacyAgreementCreateNestedManyWithoutCompaniesInput };
